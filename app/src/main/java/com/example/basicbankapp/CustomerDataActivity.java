...
public class CustomerDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(CustomerDataActivity.this);
    ...
    private void showData(String phonenumber) {
        ...
        while(cursor.moveToNext()) {
            ...
            balance.setText(String.format("Rs. %s /-", price));
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(CustomerDataActivity.this);
        View mView = getLayoutInflater().inflate(R.layout.transfer_money_alert_dialog, null);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mAmount.getText().toString().isEmpty()){
                    ...
                    mAmount.setError("Your account does not have enough balance");
                }else{
                    Intent intent = new Intent(CustomerDataActivity.this, SendToUserActivity.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(CustomerDataActivity.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DatabaseHelper(CustomerDataActivity.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
                        Toast.makeText(CustomerDataActivity.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
